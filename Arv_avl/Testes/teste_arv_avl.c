...
//gcc Testes/teste_arv_avl.c Tads/arv_avl.c Tads/album.c Tads/artista.c Tads/dados.c Tads/funcao_sistema.c Tads/musica_playlist.c Tads/musica.c Tads/playlist.c
...
int main()
{
    ...
    inserir_arv_avl(&raiz, dado_artista2, comparar_dados_nome_artista);
    inserir_arv_avl(&raiz, dado_artista1, comparar_dados_nome_artista);
    inserir_arv_avl(&raiz, dado_artista3, comparar_dados_nome_artista);
    inserir_arv_avl(&raiz, dado_artista4, comparar_dados_nome_artista);
    inserir_arv_avl(&raiz, dado_artista5, comparar_dados_nome_artista);

    imprimir_arv_avl(raiz, imprimir_dados_artista);

    // remover_arv_avl(&raiz, dado_artista3, liberar_dados_artista, comparar_dados_nome_artista);
    // printf("\n\nDepois de remover o dado artista 3:\n");

    // imprimir_arv_avl(raiz, imprimir_dados_artista);

    printf("\n\n");
    // imprimir_arv_avl(buscar_arv_avl(raiz, dado_artista1, comparar_dados_nome_artista), imprimir_dados_artista);

    printf("\n\n");
    imprimir_arv_avl_filtro(raiz, dado_artista5,imprimir_dados_artista, comparar_dados_tipo_artista);

    liberar_arv_avl(&raiz, liberar_dados_artista);
    ...
    // inserir_arv_avl(&raiz, dado_album2, comparar_dados_titulo_album);
    // inserir_arv_avl(&raiz, dado_album1, comparar_dados_titulo_album);
    // inserir_arv_avl(&raiz, dado_album3, comparar_dados_titulo_album);
    // inserir_arv_avl(&raiz, dado_album4, comparar_dados_titulo_album);

    // imprimir_arv_avl(raiz, imprimir_dados_album);

    // remover_arv_avl(&raiz, dado_album3, liberar_dados_album, comparar_dados_titulo_album);
    // printf("\n\nDepois de remover o dado album 3:\n");

    // imprimir_arv_avl(raiz, imprimir_dados_album);

    // liberar_arv_avl(&raiz, liberar_dados_album);
    ...
    // inserir_arv_avl(&raiz, dado_musica2, comparar_dados_titulo_musica);
    // inserir_arv_avl(&raiz, dado_musica1, comparar_dados_titulo_musica);
    // inserir_arv_avl(&raiz, dado_musica3, comparar_dados_titulo_musica);
    // inserir_arv_avl(&raiz, dado_musica4, comparar_dados_titulo_musica);

    // imprimir_arv_avl(raiz, imprimir_dados_musica);

    // remover_arv_avl(&raiz, dado_musica3, liberar_dados_musica, comparar_dados_titulo_musica);
    // printf("\n\nDepois de remover o dado musica 3:\n");

    // imprimir_arv_avl(raiz, imprimir_dados_musica);

    // liberar_arv_avl(&raiz, liberar_dados_musica);
    ...
    // inserir_arv_avl(&raiz, dado_playlist2, comparar_dados_nome_playlist);
    // inserir_arv_avl(&raiz, dado_playlist1, comparar_dados_nome_playlist);
    // inserir_arv_avl(&raiz, dado_playlist3, comparar_dados_nome_playlist);
    // inserir_arv_avl(&raiz, dado_playlist4, comparar_dados_nome_playlist);

    // imprimir_arv_avl(raiz, imprimir_dados_playlist);

    // remover_arv_avl(&raiz, dado_playlist3, liberar_dados_playlist, comparar_dados_nome_playlist);
    // printf("\n\nDepois de remover o dado playlist 3:\n");

    // imprimir_arv_avl(raiz, imprimir_dados_playlist);

    // liberar_arv_avl(&raiz, liberar_dados_playlist);
    ...
    // inserir_arv_avl(&raiz, dado_musica_playlist2, comparar_dados_musica_playlist);
    // inserir_arv_avl(&raiz, dado_musica_playlist1, comparar_dados_musica_playlist);
    // inserir_arv_avl(&raiz, dado_musica_playlist3, comparar_dados_musica_playlist);
    // inserir_arv_avl(&raiz, dado_musica_playlist4, comparar_dados_musica_playlist);

    // imprimir_arv_avl(raiz, imprimir_dados_musica_playlist);

    // remover_arv_avl(&raiz, dado_musica_playlist3, liberar_dados_musica_playlist, comparar_dados_musica_playlist);
    // printf("\n\nDepois de remover o dado musica playlist 3:\n");

    // imprimir_arv_avl(raiz, imprimir_dados_musica_playlist);

    // liberar_arv_avl(&raiz, liberar_dados_musica_playlist);
